...
// modified to allow time parameter
var URL = 'http://www.google.%s/search?hl=%s&q=%s&start=%s&sa=N&num=%s&ie=UTF-8&oe=UTF-8&tbs=qdr:%s'
...
// more accurate results by timeframe
// source: webdistortion.com/2012/02/19/need-a-more-realtime-google-search-try-this-hack
// default to results in past year
google.resultsTimeFrame = 'y'
...
// modified to pass in resultsTimeFrame prop
  var newUrl = util.format(URL, google.tld, google.lang, querystring.escape(query), start, google.resultsPerPage, google.resultsTimeFrame)
  var requestOptions = {
    url: newUrl,
    method: 'GET'
  }
