...
var igoogle = function (query, start, callback) {
  ...
  if (google.resultsTimeFrame) {
    URL = URL.indexOf('tbs=qdr:') >= 0 ? URL.replace(/tbs=qdr:[snhdwmy]\d*/, 'tbs=qdr:' + google.resultsTimeFrame) : URL.concat('&tbs=qdr:', google.resultsTimeFrame)
  }
